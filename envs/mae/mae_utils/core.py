...
class ExtraConstants:
    def __init__(self):
        ...
        self.NX_SCALE = 2
        self.NY_SCALE = 5
        self.GA_SCALE = np.pi  # math.pi/2.25
...
class World:  
    ...
    def __init__(self, 
                 extra_constants: ExtraConstants = ExtraConstants()):
        """
        ...
        # pi
        self.pi = np.pi
        self.constant = extra_constants    
        self.dt = self.constant.TAU
