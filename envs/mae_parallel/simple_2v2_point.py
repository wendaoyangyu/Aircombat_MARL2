...
"""
    ...
    NOTE:
    1. 该环境基于simple_2v2，根据scripts_to_agents指定了目标
    2. 奖励基于AirCombat_CX，将胜负奖励调整为+/-20，但删除了超出循环奖励
"""
...
class Scenario(BaseScenario):
    ...
    def reward(self, agent: Agent, env: BaseEnv):
        ...
        s = env.agents_to_scripts[agent.name]
        ...
        r_inside = self.single_close_reward(agent.unpack, script.unpack, end_on=False)
